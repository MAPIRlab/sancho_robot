...
def main():
    ...
    _dock_pose.pose.position.x = -7.10
    _dock_pose.pose.position.y = 1.55
    ...
    arbitration_bb.register_key(key="mission/cancel_requested", access=py_trees.common.Access.WRITE)
    ...
    arbitration_bb.set("mission/cancel_requested", False)
