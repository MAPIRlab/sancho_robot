...
def generate_launch_description():
    ...
    group_detection_node = LifecycleNode(
        namespace="",
        package="sancho_perception",
        executable="single_person_detector_node",
        name="single_person_detector_node",
        output="screen",
        prefix=prefix_cmd,
        emulate_tty=True,
    )
    ...
    group_waypoint_generator_node = LifecycleNode(
        namespace="",
        package="sancho_perception",
        executable="single_person_waypoint_generator_node",
        name="single_person_waypoint_generator_node",
        output="screen",
        prefix=prefix_cmd,
        emulate_tty=True,
    )
