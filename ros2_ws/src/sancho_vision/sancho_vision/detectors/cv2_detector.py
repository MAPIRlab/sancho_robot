...
class CV2Detector(BaseDetector):
    ...
    def __init__(self):
        self.face_detector = cv2.CascadeClassifier('/home/mapir/sancho_refactor/ros2_ws/src/sancho_vision/sancho_vision/models/haarcascade_frontalface_default.xml')
