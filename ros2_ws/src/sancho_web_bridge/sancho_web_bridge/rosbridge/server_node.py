...
class ServerNode(DynamicSubscribableNode):
    ...
    def __init__(self):
        ...
        self.ros_sub = self.create_subscription(R2WMessage, "sancho_web_bridge.rosbridge/ros", self.server_callback, 10)
        self.web_pub = self.create_publisher(R2WMessage, "sancho_web_bridge.rosbridge/web", 10)
