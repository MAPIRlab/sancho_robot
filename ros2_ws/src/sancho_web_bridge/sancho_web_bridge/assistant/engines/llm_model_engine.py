...
class LLMModelEngine(ServiceEngine):
    def __init__(self, node):
        ...
        self.load_model_cli = self.create_client(LLMLoadModel, 'llm_tools/load_model')
        self.unload_model_cli = self.create_client(LLMUnloadModel, 'llm_tools/unload_model')
