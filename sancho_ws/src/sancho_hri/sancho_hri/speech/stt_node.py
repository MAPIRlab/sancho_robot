...
from sancho_interfaces.msg import SpeechLoadUnloadResult, ModelItem
from sancho_interfaces.srv import STT, STTGetActiveModel, STTGetModels, STTSetActiveModel, SpeechLoadModel, SpeechUnloadModel
...
class STTNode(Node):
    ...
    MODELS_CLASS_MAP = {
        STT_MODELS.WHISPER: ("sancho_hri.speech.stt.whisper_stt", "WhisperSTT"),
        STT_MODELS.GOOGLE: ("sancho_hri.speech.stt.google_stt", "GoogleSTT"),
    }
