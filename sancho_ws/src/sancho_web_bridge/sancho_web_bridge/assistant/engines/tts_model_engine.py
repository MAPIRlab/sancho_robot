...
from sancho_interfaces.srv import TTSGetActiveModel, TTSGetModels, TTSSetActiveModel, SpeechLoadModel, SpeechUnloadModel
...
class TTSModelEngine(ServiceEngine):
    def __init__(self, node):
        ...
        self.load_model_cli = self.create_client(SpeechLoadModel, 'speech_tools/tts/load_model')
        self.unload_model_cli = self.create_client(SpeechUnloadModel, 'speech_tools/tts/unload_model')
