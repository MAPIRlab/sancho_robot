...
class STTModelEngine(ServiceEngine):
    def __init__(self, node):
        ...
        self.load_model_cli = self.create_client(SpeechLoadModel, 'speech_tools/stt/load_model')
        self.unload_model_cli = self.create_client(SpeechUnloadModel, 'speech_tools/stt/unload_model')
